    ...
    return (
        <div className="ui card">
            <div className="content">
                <h4 className="ui sub header">Nome : {renderName(starship.name)}</h4>
                <h4 className="ui sub header">Tripulação : {renderNumber(starship.crew)}</h4>
                <h4 className="ui sub header">Passageiros : {renderNumber(starship.passengers)}</h4>
